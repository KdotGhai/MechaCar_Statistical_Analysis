...
# Use summary() function to determine p-value,r^2 value for linear regression model(lm)
summary(lm(mpg ~ vehicle_length + vehicle_weight + spoiler_angle + ground_clearance + AWD, mecha_car_mpg))

# p-value: 5.35e-11
# Adjusted r-squared: 0.6825  (PREFERRED SINCE ITS MORE ACCURATE FOR EACH INDEPENDENT VARIABLE ADDED)
# Multiple r^2:0.7149
